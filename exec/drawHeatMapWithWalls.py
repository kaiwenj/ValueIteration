...
def drawHeatMap(V, policy, vmin, vmax, trapDict, bonusDict, blockList, walls):
    VPlot=V.copy()
    ...
    for wall in walls:
        end1, end2 = wall
        heatMap.plot([end1[0]+0.5, end2[0]+0.5], [end1[1]+0.5, end2[1]+0.5], color='orange', linewidth=4)
...
def drawFinalMap(V, policy, trapDict, bonusDict, blockList, normalCost, walls):
    ...
    drawHeatMap(V, policy, vmin, vmax, trapDict, bonusDict, blockList, walls)
    plt.savefig(f'valueIteration_R={normalCost}.jpg')
